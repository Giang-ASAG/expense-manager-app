...
class _ManageCategoriesPageState extends State<ManageCategoriesPage>
  ...
  void _onAddNewCategory() {
    ...
    Navigator.push(
      context,
      PageRouteBuilder(
        pageBuilder: (_, animation, __) => AddCategoryPage(isExpense: isExpense,),
  ...
  void _onEditCategory(CategoryModel category) {
    // TODO: navigate to edit page
    print('Sửa danh mục: ${category.name}');
  }
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    print('Xóa danh mục: ${category.name}');
                  },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: userId == null
          ...
          : Column(
        children: [
          // Toggle + Header in a styled top section
          _buildTopSection(),
          // List
          Expanded(child: _buildCategoryListStream()),
          // Bottom bar
          _buildBottomActions(),
        ],
      ),
  ...
  Widget _buildCategoryListStream() {
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.category_outlined, size: 48, color: accentColor.withOpacity(0.5)),
            ),
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: const Icon(Icons.swap_vert_rounded, color: AppColors.textPrimary, size: 22),
            ),
          ),
          const SizedBox(width: 12),
          // Add new button
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: (isExpense ? AppColors.danger : AppColors.success).withOpacity(0.35),
                      blurRadius: 12,
                      offset: const Offset(0, 4),
                    ),
                  ],
